...
def cysteine(self):
    ...
    ch3 = ax.plot([ch3_max[0], ch3_min[0]], [ch3_max[1], ch3_min[1]], [ch3_max[2], ch3_min[2]], linewidth=5,
                  color=ch_color,
                  marker='o', markerfacecolor='orange', markersize=12)
    cs = ax.plot([cs_max[0], cs_min[0]], [cs_max[1], cs_min[1]], [cs_max[2], cs_min[2]], linewidth=5,
                 color=cs_color,
                 marker='o', markerfacecolor='orange', markersize=12)
    sh = ax.plot([sh_max[0], sh_min[0]], [sh_max[1], sh_min[1]], [sh_max[2], sh_min[2]], linewidth=5,
                  color=sh_color,
                  marker='o', markerfacecolor='orange', markersize=12)
    ...
    tsh = plt.Rectangle((0, 0), 1, 1, fc=sh_color)


    ax.legend([tch,tcn,tcc,tbco,tbnh,tcs,tsh],['ch','cn','cc','co','nh','cs','sh'])
    ax.axis("off")  
