...
def tyrosine(self):
    ...
    pc3OH_min = [25,-120, 130]
    pc3OH_max = [10, -140, 110]
...
##########################################################################################################################
    ...
    cch1 = ax.plot([cch1_max[0], cch1_min[0]], [cch1_max[1], cch1_min[1]], [cch1_max[2], cch1_min[2]],
                  color=ch_color, linewidth=5, marker='o', markerfacecolor='orange', markersize=12)

    cch2 = ax.plot([cch2_max[0], cch2_min[0]], [cch2_max[1], cch2_min[1]], [cch2_max[2], cch2_min[2]],
                  color=ch_color, linewidth=5, marker='o', markerfacecolor='orange', markersize=12)

    ccc3 = ax.plot([ ccc3_max[0], ccc3_min[0]], [ ccc3_max[1], ccc3_min[1]], [ ccc3_max[2], ccc3_min[2]],
                 color=cc_color, linewidth=5, marker='o', markerfacecolor='orange', markersize=12)

    pc1 = ax.plot([pc1_max[0], pc1_min[0]], [pc1_max[1], pc1_min[1]], [pc1_max[2], pc1_min[2]],
                  color=pc_color, linewidth=5, marker='o', markerfacecolor='orange', markersize=12)
    pc1h = ax.plot([pc1h_max[0], pc1h_min[0]], [pc1h_max[1], pc1h_min[1]], [pc1h_max[2], pc1h_min[2]],
                  color=ch_color, linewidth=5, marker='o', markerfacecolor='orange', markersize=12)
    ...
    pc30 = ax.plot([ pc30_max[0], pc30_min[0]], [ pc30_max[1],  pc30_min[1]], [ pc30_max[2], pc30_min[2]],color=co_color,
                  linewidth=5, marker='o', markerfacecolor='orange', markersize=12)
    pc3OH = ax.plot([ pc3OH_max[0],  pc3OH_min[0]], [ pc3OH_max[1],  pc3OH_min[1]], [ pc3OH_max[2],  pc3OH_min[2]],
                    color=oh_color,
                   linewidth=5, marker='o', markerfacecolor='orange', markersize=12)

    pc4 = ax.plot([ pc4_max[0],  pc4_min[0]], [ pc4_max[1], pc4_min[1]], [ pc4_max[2],  pc4_min[2]], color=pc_color,
                  linewidth=5, marker='o', markerfacecolor='orange', markersize=12)

    pc4h = ax.plot([pc4h_max[0],pc4h_min[0]], [pc4h_max[1], pc4h_min[1]], [pc4h_max[2],pc4h_min[2]],color=ch_color,
                   linewidth=5, marker='o', markerfacecolor='orange', markersize=12)

    pc5 = ax.plot([pc5_max[0], pc5_min[0]], [pc5_max[1],pc5_min[1]], [pc5_max[2],pc5_min[2]], color=pc_color,
                  linewidth=5, marker='o', markerfacecolor='orange', markersize=12)

    pc5h = ax.plot([ pc5h_max[0],  pc5h_min[0]], [ pc5h_max[1],  pc5h_min[1]], [ pc5h_max[2],  pc5h_min[2]],color=ch_color,
                   linewidth=5, marker='o', markerfacecolor='orange', markersize=12)

    pc6 = ax.plot([ pc6_max[0],  pc6_min[0]], [ pc6_max[1],  pc6_min[1]], [ pc6_max[2],  pc6_min[2]], color=pc_color,
                  linewidth=5, marker='o', markerfacecolor='orange', markersize=12)
    ...
    ax.legend([tch,tcn,tcc,tbco,tbnh,tpc,toh],['ch','cn','cc','co','nh','pc','oh'])
