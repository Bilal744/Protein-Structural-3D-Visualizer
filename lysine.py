...
def lysine(self):
    ...
    c5n1h1_min = [280, -120, 130]
    c5n1h1_max = [310, -150, 100]

    c5n1h2_min = [280, -120, 130]
    c5n1h2_max = [250, -180, 160]

    c5n1h3_min = [280, -120, 130]
    c5n1h3_max = [320, -190, 130]
    ...
    c4h2 = ax.plot([c4h2_max[0], c4h2_min[0]], [c4h2_max[1], c4h2_min[1]], [c4h2_max[2], c4h2_min[2]],
                     ...
                     color=ch_color,
                     marker='o', markerfacecolor='orange', markersize=12)
    c51 = ax.plot([c51_max[0], c51_min[0]], [c51_max[1], c51_min[1]], [c51_max[2], c51_min[2]],
                     linewidth=5,
                     color=cc_color,
                     marker='o', markerfacecolor='orange', markersize=12)
    c5n1 = ax.plot([c5n1_max[0],c5n1_min[0]], [c5n1_max[1], c5n1_min[1]], [c5n1_max[2], c5n1_min[2]], linewidth=5,
                  color=cn_color,
                  marker='o', markerfacecolor='orange', markersize=12)
    c5n1h1 = ax.plot([c5n1h1_max[0], c5n1h1_min[0]], [c5n1h1_max[1], c5n1h1_min[1]], [c5n1h1_max[2], c5n1h1_min[2]], linewidth=5,
                  color=nh_color,
                  marker='o', markerfacecolor='orange', markersize=12)
    c5n1h2 = ax.plot([c5n1h2_max[0], c5n1h2_min[0]], [c5n1h2_max[1], c5n1h2_min[1]], [c5n1h2_max[2], c5n1h2_min[2]],
                     linewidth=5,
                     color=nh_color,
                     marker='o', markerfacecolor='orange', markersize=12)
    c5n1h3 = ax.plot([c5n1h3_max[0], c5n1h3_min[0]], [c5n1h3_max[1], c5n1h3_min[1]], [c5n1h3_max[2], c5n1h3_min[2]],
                     linewidth=5,
                     color=nh_color,
                     marker='o', markerfacecolor='orange', markersize=12)
    c5h1 = ax.plot([c5h1_max[0], c5h1_min[0]], [c5h1_max[1], c5h1_min[1]], [c5h1_max[2], c5h1_min[2]], linewidth=5,
                   color=ch_color,
                   marker='o', markerfacecolor='orange', markersize=12)
    c5h2 = ax.plot([c5h2_max[0], c5h2_min[0]], [c5h2_max[1], c5h2_min[1]], [c5h2_max[2], c5h2_min[2]], linewidth=5,
                   color=ch_color,
                   marker='o', markerfacecolor='orange', markersize=12)
